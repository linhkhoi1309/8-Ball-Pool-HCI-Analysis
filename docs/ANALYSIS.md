...
| HCI Concept | Concrete Interface Drawback | Specific Use Case Example | Why It Is a Problem |
| --- | --- | --- | --- |
| Human capabilities |  |  |  |
| Mental model |  |  |  |
...
| Expert user |  |  |  |
| User in motion |  |  |  |
| User in poor lighting |  |  |  |
| User with accessibility needs |  |  |  |

## 7. Potential Solutions Identification

For each drawback found in Sections 2 and 3, propose a practical solution. The solution should directly address the HCI problem.

| Product | Drawback | Proposed Solution | HCI Principle Addressed | How the Solution Helps |
| --- | --- | --- | --- | --- |
| [Product 1] | [Specific drawback] | [Specific solution] | [Visibility, feedback, consistency, accessibility, error prevention, etc.] | [Explain how this reduces difficulty for users] |
| [Product 1] | [Specific drawback] | [Specific solution] | [HCI principle] | [Explanation] |
| [Product 2] | [Specific drawback] | [Specific solution] | [HCI principle] | [Explanation] |
| [Product 2] | [Specific drawback] | [Specific solution] | [HCI principle] | [Explanation] |

### 7.1 Example Solution Format

Use this format when writing each solution in paragraph form:

> One drawback of [product] is that [specific interface problem] occurs when [specific user] tries to [specific task] in [specific context]. This is problematic because [HCI explanation]. A practical solution is to [proposed design change]. This solution improves [HCI principle] because it allows the user to [specific improvement], reducing [error/confusion/time/effort].

## 8. Conclusion

Summarize the key findings:

- Which product provides a better user experience overall?
- Which product has clearer interaction design?
- Which product has more serious usability drawbacks?
- What general HCI lesson can be learned from comparing the two products?

Example structure:

> In conclusion, both products support sports-related activities, but they create different user experiences because of their interface design choices. [Product 1] is stronger in [area], while [Product 2] is stronger in [area]. However, both products still have drawbacks related to [main issues]. By applying HCI principles such as visibility, feedback, consistency, accessibility, and error prevention, these products can provide a more efficient and comfortable experience for different types of users.

## 9. References

List any sources used, such as:

- Official product websites
- App store pages
- Screenshots from the product
- HCI course slides or textbooks
- Nielsen usability heuristics, if allowed by the course
